                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-600 rounded-sm shadow-sm bg-gray-700 text-white focus:ring-2 focus:ring-blue-300"
                                value={username}
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-full bg-blue-500 text-white px-4 py-2 rounded-sm hover:bg-blue-600 focus:outline-none"
                            >
                                Login
                            </button>
                        </div>
